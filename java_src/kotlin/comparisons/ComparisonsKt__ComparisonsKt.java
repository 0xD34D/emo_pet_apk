...
class ComparisonsKt__ComparisonsKt {
    ...
    public static final <T> Comparator<T> then(final Comparator<T> receiver$0, final Comparator<? super T> comparator) {
    ...
    public static final <T> Comparator<T> thenDescending(final Comparator<T> receiver$0, final Comparator<? super T> comparator) {
        Intrinsics.checkParameterIsNotNull(receiver$0, "receiver$0");
        Intrinsics.checkParameterIsNotNull(comparator, "comparator");
    ...
    public static final <T> Comparator<T> reversed(Comparator<T> receiver$0) {
        Intrinsics.checkParameterIsNotNull(receiver$0, "receiver$0");
        if (receiver$0 instanceof ReversedComparator) {
            return ((ReversedComparator) receiver$0).getComparator();
        }
        if (Intrinsics.areEqual(receiver$0, NaturalOrderComparator.INSTANCE)) {
            ReverseOrderComparator reverseOrderComparator = ReverseOrderComparator.INSTANCE;
            if (reverseOrderComparator != null) {
                return reverseOrderComparator;
            }
            ...
            return new ReversedComparator(receiver$0);
        } else {
            NaturalOrderComparator naturalOrderComparator = NaturalOrderComparator.INSTANCE;
            if (naturalOrderComparator != null) {
                return naturalOrderComparator;
