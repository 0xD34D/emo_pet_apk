...
class CollectionsKt__CollectionsKt extends CollectionsKt__CollectionsJVMKt {
    ...
    public static final IntRange getIndices(Collection<?> receiver$0) {
        Intrinsics.checkParameterIsNotNull(receiver$0, "receiver$0");
        return new IntRange(0, receiver$0.size() - 1);
    }

    public static final <T> int getLastIndex(List<? extends T> receiver$0) {
        Intrinsics.checkParameterIsNotNull(receiver$0, "receiver$0");
    ...
    /* JADX WARN: Multi-variable type inference failed */
    public static final <T> List<T> optimizeReadOnlyList(List<? extends T> receiver$0) {
        Intrinsics.checkParameterIsNotNull(receiver$0, "receiver$0");
        int size = receiver$0.size();
        if (size != 0) {
            return size != 1 ? receiver$0 : CollectionsKt.listOf(receiver$0.get(0));
        }
        return CollectionsKt.emptyList();
    }
    ...
    public static final <T extends Comparable<? super T>> int binarySearch(List<? extends T> receiver$0, T t, int i, int i2) {
        Intrinsics.checkParameterIsNotNull(receiver$0, "receiver$0");
    ...
    public static final <T> int binarySearch(List<? extends T> receiver$0, T t, Comparator<? super T> comparator, int i, int i2) {
        Intrinsics.checkParameterIsNotNull(receiver$0, "receiver$0");
    ...
    public static final <T, K extends Comparable<? super K>> int binarySearchBy(List<? extends T> receiver$0, K k, int i, int i2, Function1<? super T, ? extends K> selector) {
        Intrinsics.checkParameterIsNotNull(receiver$0, "receiver$0");
        Intrinsics.checkParameterIsNotNull(selector, "selector");
    ...
    public static final <T> int binarySearch(List<? extends T> receiver$0, int i, int i2, Function1<? super T, Integer> comparison) {
        Intrinsics.checkParameterIsNotNull(receiver$0, "receiver$0");
