...
class StringsKt__StringsJVMKt extends StringsKt__StringNumberConversionsKt {
    ...
    public static final String replace(String receiver$0, char c, char c2, boolean z) {
    ...
    public static final String replace(String receiver$0, String oldValue, String newValue, boolean z) {
        Intrinsics.checkParameterIsNotNull(receiver$0, "receiver$0");
    ...
    public static final String replaceFirst(String receiver$0, char c, char c2, boolean z) {
        Intrinsics.checkParameterIsNotNull(receiver$0, "receiver$0");
        String str = receiver$0;
        int indexOf$default = StringsKt.indexOf$default(str, c, 0, z, 2, (Object) null);
        return indexOf$default < 0 ? receiver$0 : StringsKt.replaceRange((CharSequence) str, indexOf$default, indexOf$default + 1, (CharSequence) String.valueOf(c2)).toString();
    }
    ...
    public static final String replaceFirst(String receiver$0, String oldValue, String newValue, boolean z) {
        Intrinsics.checkParameterIsNotNull(receiver$0, "receiver$0");
        Intrinsics.checkParameterIsNotNull(oldValue, "oldValue");
        Intrinsics.checkParameterIsNotNull(newValue, "newValue");
        String str = receiver$0;
        int indexOf$default = StringsKt.indexOf$default(str, oldValue, 0, z, 2, (Object) null);
        return indexOf$default < 0 ? receiver$0 : StringsKt.replaceRange((CharSequence) str, indexOf$default, oldValue.length() + indexOf$default, (CharSequence) newValue).toString();
    }
    ...
    public static final List<String> split(CharSequence receiver$0, Pattern regex, int i) {
        Intrinsics.checkParameterIsNotNull(receiver$0, "receiver$0");
        ...
        if (i >= 0) {
            ...
            String[] split = regex.split(receiver$0, i);
    ...
    public static final boolean startsWith(String receiver$0, String prefix, boolean z) {
        Intrinsics.checkParameterIsNotNull(receiver$0, "receiver$0");
        Intrinsics.checkParameterIsNotNull(prefix, "prefix");
        if (!z) {
            return receiver$0.startsWith(prefix);
        }
        return StringsKt.regionMatches(receiver$0, 0, prefix, 0, prefix.length(), z);
    }
    ...
    public static final boolean startsWith(String receiver$0, String prefix, int i, boolean z) {
        Intrinsics.checkParameterIsNotNull(receiver$0, "receiver$0");
        Intrinsics.checkParameterIsNotNull(prefix, "prefix");
        if (!z) {
            return receiver$0.startsWith(prefix, i);
        }
        return StringsKt.regionMatches(receiver$0, i, prefix, 0, prefix.length(), z);
    }
    ...
    public static final boolean endsWith(String receiver$0, String suffix, boolean z) {
        Intrinsics.checkParameterIsNotNull(receiver$0, "receiver$0");
        Intrinsics.checkParameterIsNotNull(suffix, "suffix");
        if (!z) {
            return receiver$0.endsWith(suffix);
        }
        return StringsKt.regionMatches(receiver$0, receiver$0.length() - suffix.length(), suffix, 0, suffix.length(), true);
    }
    ...
    public static final int compareTo(String receiver$0, String other, boolean z) {
        Intrinsics.checkParameterIsNotNull(receiver$0, "receiver$0");
        Intrinsics.checkParameterIsNotNull(other, "other");
        if (z) {
            return receiver$0.compareToIgnoreCase(other);
        }
        return receiver$0.compareTo(other);
    }
    ...
    public static final boolean isBlank(CharSequence receiver$0) {
        ...
        if (receiver$0.length() != 0) {
            IntRange indices = StringsKt.getIndices(receiver$0);
    ...
    public static final boolean regionMatches(CharSequence receiver$0, int i, CharSequence other, int i2, int i3, boolean z) {
        Intrinsics.checkParameterIsNotNull(receiver$0, "receiver$0");
        Intrinsics.checkParameterIsNotNull(other, "other");
        if (!(receiver$0 instanceof String) || !(other instanceof String)) {
            return StringsKt.regionMatchesImpl(receiver$0, i, other, i2, i3, z);
        }
        return StringsKt.regionMatches((String) receiver$0, i, (String) other, i2, i3, z);
    }
    ...
    public static final boolean regionMatches(String receiver$0, int i, String other, int i2, int i3, boolean z) {
        ...
        Intrinsics.checkParameterIsNotNull(other, "other");
        if (!z) {
            return receiver$0.regionMatches(i, other, i2, i3);
        }
        return receiver$0.regionMatches(z, i, other, i2, i3);
    }
    ...
    public static final String capitalize(String receiver$0) {
        Intrinsics.checkParameterIsNotNull(receiver$0, "receiver$0");
    ...
    public static final String decapitalize(String receiver$0) {
        Intrinsics.checkParameterIsNotNull(receiver$0, "receiver$0");
        if (!(receiver$0.length() > 0) || !Character.isUpperCase(receiver$0.charAt(0))) {
            return receiver$0;
        }
        StringBuilder sb = new StringBuilder();
        String substring = receiver$0.substring(0, 1);
    ...
    public static final Comparator<String> getCASE_INSENSITIVE_ORDER(StringCompanionObject receiver$0) {
        Intrinsics.checkParameterIsNotNull(receiver$0, "receiver$0");
