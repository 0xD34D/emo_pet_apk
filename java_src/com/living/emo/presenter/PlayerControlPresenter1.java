...
public class PlayerControlPresenter1 extends Binder implements IPlayerControlPresenter {
    private static final String TAG = "com.living.emo.presenter.PlayerControlPresenter1";
    ...
    public void initMediaPlayer() {
        ...
        if (this.mCurrentState == 3) {
            try {
                ...
                this.mMediaPlayer.setOnCompletionListener(new MediaPlayer.OnCompletionListener() { // from class: com.living.emo.presenter.PlayerControlPresenter1.1
                    @Override // android.media.MediaPlayer.OnCompletionListener
                    public void onCompletion(MediaPlayer mediaPlayer) {
                        LogUtil.m65d(PlayerControlPresenter1.TAG, "--------------setOnCompletionListener-------------------");
                        PlayerControlPresenter1.this.mCurrentState = 3;
                        PlayerControlPresenter1.this.notificationChange();
                        PlayerControlPresenter1.this.threadStop();
                        PlayerControlPresenter1.this.reset();
                        PlayerControlPresenter1.this.initMediaPlayer();
                    }
                });
            } catch (IOException e) {
                e.printStackTrace();
    ...
    public class MyTask implements Runnable {
        ...
        public void run() {
            PlayerControlPresenter1.this.mCallback.onChangeSeekBar(PlayerControlPresenter1.this.getStayTime(), PlayerControlPresenter1.this.getCurrPosition());
        }
    }
}
