...
class TimePickerClockPresenter implements ClockHandView.OnRotateListener, TimePickerView.OnSelectionChange, TimePickerView.OnPeriodChangeListener, ClockHandView.OnActionUpListener, TimePickerPresenter {
    ...
    void setSelection(int i, boolean z) {
        ...
        this.timePickerView.setValues(z2 ? MINUTE_CLOCK_VALUES : getHourClockValues(), z2 ? C0670R.string.material_minute_suffix : C0670R.string.material_hour_suffix);
        ...
        timePickerView.setMinuteHourDelegate(new ClickActionDelegate(timePickerView.getContext(), C0670R.string.material_hour_selection));
        TimePickerView timePickerView2 = this.timePickerView;
        timePickerView2.setHourClickDelegate(new ClickActionDelegate(timePickerView2.getContext(), C0670R.string.material_minute_selection));
    }
