...
public final class C1245a {
    ...
    /* renamed from: a */
    private static final Map<Integer, String> f814a;

    /* renamed from: b */
    private static final Map<Integer, String> f815b;
    ...
    /* renamed from: a */
    public static String m146a(int i) {
        Map<Integer, String> map = f814a;
        Integer valueOf = Integer.valueOf(i);
        if (!map.containsKey(valueOf)) {
            return "";
        }
        Map<Integer, String> map2 = f815b;
