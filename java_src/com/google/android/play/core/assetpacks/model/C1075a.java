...
public final class C1075a {
    ...
    /* renamed from: a */
    private static final Map<Integer, String> f559a;

    /* renamed from: b */
    private static final Map<Integer, String> f560b;
    ...
    /* renamed from: a */
    public static String m476a(int i) {
        Map<Integer, String> map = f559a;
        Integer valueOf = Integer.valueOf(i);
        if (!map.containsKey(valueOf)) {
            return "";
        }
        String str = map.get(valueOf);
        String str2 = f560b.get(valueOf);
