...
public final class Buffer implements BufferedSource, BufferedSink, Cloneable, ByteChannel {
    ...
    public long readLong() {
        if (this.size >= 8) {
            ...
            int i9 = i8 + 1;
            int i10 = i9 + 1;
            long j = (bArr[i9] & 255) | ((bArr[i] & 255) << 56) | ((bArr[i3] & 255) << 48) | ((bArr[i4] & 255) << 40) | ((bArr[i5] & 255) << 32) | ((bArr[i6] & 255) << 24) | ((bArr[i7] & 255) << 16) | ((bArr[i8] & 255) << 8);
            this.size -= 8;
            if (i10 == i2) {
                this.head = segment.pop();
                SegmentPool.recycle(segment);
    ...
    */
        ...
        if (segment2 != null) {
            ...
            loop0: while (true) {
                ...
                if (i10 < 0) {
                    ...
                    int i16 = i5 + 1;
                    int i17 = bArr[i5] & UByte.MAX_VALUE;
                    int i18 = i11 + i10;
                    while (i11 != i18) {
                        if (i17 == iArr[i11]) {
                            i = iArr[i11 + i10];
    ...
    private ByteString digest(String str) {
        try {
            ...
            return ByteString.m13of(instance.digest());
    ...
    private ByteString hmac(String str, ByteString byteString) {
        try {
            ...
            return ByteString.m13of(instance.doFinal());
