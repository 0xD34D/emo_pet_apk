    ...
    */
    private static InetAddress decodeIpv6(String str, int i, int i2) {
                ...
                if (i5 != 16) {
                    ...
                    if (i5 != 0) {
                        if (str.regionMatches(i, ":", 0, 1)) {
                            i++;
                        } else if (!str.regionMatches(i, ".", 0, 1) || !decodeIpv4Suffix(str, i, i2, bArr, i5 - 2)) {
                            return null;
                        } else {
                            i5 += 2;
                        }
                    ...
                    int i8 = i5 + 1;
                    bArr[i5] = (byte) ((i72 >>> 8) & 255);
                    i5 = i8 + 1;
                    bArr[i8] = (byte) (i72 & 255);
                } else {
                    return null;
                }
            } else {
        ...
        if (i5 != 16) {
            ...
            int i9 = i5 - i4;
            System.arraycopy(bArr, i4, bArr, 16 - i9, i9);
            Arrays.fill(bArr, i4, (16 - i5) + i4, (byte) 0);
        }
        try {
