    ...
    public long solverMeasure(ConstraintWidgetContainer constraintWidgetContainer, int i, int i2, int i3, int i4, int i5, int i6, int i7, int i8, int i9) {
        ...
        if (z4) {
            for (int i12 = 0; i12 < size; i12++) {
                ConstraintWidget constraintWidget = (ConstraintWidget) constraintWidgetContainer.mChildren.get(i12);
        ...
        if (size2 > 0) {
            ...
            while (i17 < i13) {
                ...
                if (z8) {
                    i15 = i15;
                    i16 = i16;
                    solveLinearSystem(constraintWidgetContainer, "intermediate pass", i15, i16);
                    z8 = false;
                } else {
                    i15 = i15;
                    i16 = i16;
            ...
            if (z8) {
                solveLinearSystem(constraintWidgetContainer, "2nd pass", i15, i16);
                ...
                if (z2) {
                    solveLinearSystem(constraintWidgetContainer, "3rd pass", i15, i16);
                }
            }
            optimizationLevel = optimizationLevel;
        }
