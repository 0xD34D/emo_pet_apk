...
public class HorizontalWidgetRun extends WidgetRun {
    ...
    */
    public void update(Dependency dependency) {
        ...
        float f2;
        float f3;
        int i2 = C01681.f42xbf6f0c8e[this.mRunType.ordinal()];
        if (i2 == 1) {
            ...
            if (i3 == 2) {
                ...
                if (this.widget.mMatchConstraintDefaultHeight == 0 || this.widget.mMatchConstraintDefaultHeight == 3) {
                    ...
                    if (z && z2 && z3 && z4) {
                        ...
                        if (z2 && z4) {
                            if (dependencyNode.readyToSolve && dependencyNode2.readyToSolve) {
                                ...
                                int i7 = (int) ((limitedDimension3 / dimensionRatio2) + 0.5f);
                        ...
                        if (dimensionRatioSide == -1 || dimensionRatioSide == 0) {
                            ...
                            int i10 = (int) ((limitedDimension5 * dimensionRatio3) + 0.5f);
                            ...
                            int i11 = (int) ((limitedDimension7 / dimensionRatio3) + 0.5f);
                    ...
                    if (dimensionRatioSide2 == -1) {
                        f3 = this.widget.verticalRun.dimension.value;
                        f2 = this.widget.getDimensionRatio();
                    } else if (dimensionRatioSide2 == 0) {
                        f = this.widget.verticalRun.dimension.value / this.widget.getDimensionRatio();
                        i = (int) (f + 0.5f);
