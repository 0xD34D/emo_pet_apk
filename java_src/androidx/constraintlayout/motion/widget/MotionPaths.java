...
public class MotionPaths implements Comparable<MotionPaths> {
    ...
    void initCartesian(KeyPosition keyPosition, MotionPaths motionPaths, MotionPaths motionPaths2) {
        ...
        this.mMode = 2;
        this.f29x = (int) (((motionPaths.f29x + (f16 * f10)) + (f17 * f11)) - f13);
        this.f30y = (int) (((motionPaths.f30y + (f10 * f18)) + (f11 * f)) - f15);
    ...
    void initPath(KeyPosition keyPosition, MotionPaths motionPaths, MotionPaths motionPaths2) {
        ...
        float f13 = f4 * f2;
        float f14 = f13 / 2.0f;
        this.f29x = (int) ((f6 + f12) - f14);
        float f15 = f * f11;
        float f16 = f5 * f3;
        float f17 = f16 / 2.0f;
        this.f30y = (int) ((f8 + f15) - f17);
        this.width = (int) (f7 + f13);
        this.height = (int) (f9 + f16);
        float f18 = Float.isNaN(keyPosition.mPercentY) ? 0.0f : keyPosition.mPercentY;
        this.mMode = 1;
        float f19 = (int) ((motionPaths.f29x + f12) - f14);
        this.f29x = f19;
        float f20 = (int) ((motionPaths.f30y + f15) - f17);
        this.f30y = f20;
        this.f29x = f19 + ((-f11) * f18);
        this.f30y = f20 + (f10 * f18);
        this.mKeyFrameEasing = Easing.getInterpolator(keyPosition.mTransitionEasing);
        this.mPathMotionArc = keyPosition.mPathMotionArc;
    }
    ...
    public void setView(View view, int[] iArr, double[] dArr, double[] dArr2, double[] dArr3) {
        ...
        int i8 = i6 - i4;
        int i9 = i7 - i5;
        if ((i8 == view.getMeasuredWidth() && i9 == view.getMeasuredHeight()) ? false : z) {
