...
public class FragmentAnim {
    ...
    public static AnimationOrAnimator loadAnimation(Context context, FragmentContainer fragmentContainer, Fragment fragment, boolean z) {
        ...
        if (!(onFindViewById == null || onFindViewById.getTag(C0340R.C0343id.visible_removing_fragment_view_tag) == null)) {
            onFindViewById.setTag(C0340R.C0343id.visible_removing_fragment_view_tag, null);
        }
    ...
    private static int transitToAnimResourceId(int i, boolean z) {
        if (i == 4097) {
            return z ? C0340R.anim.fragment_open_enter : C0340R.anim.fragment_open_exit;
        }
        if (i == 4099) {
            return z ? C0340R.anim.fragment_fade_enter : C0340R.anim.fragment_fade_exit;
        }
        if (i != 8194) {
            return -1;
        }
        return z ? C0340R.anim.fragment_close_enter : C0340R.anim.fragment_close_exit;
    }
