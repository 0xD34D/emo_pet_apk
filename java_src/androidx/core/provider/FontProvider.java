...
class FontProvider {
    ...
    static FontsContractCompat.FontInfo[] query(Context context, FontRequest fontRequest, String str, CancellationSignal cancellationSignal) {
        ...
        Cursor cursor = null;
        try {
            String[] strArr = {Constants.DATABASE_TABLE_FIELD_ID, FontsContractCompat.Columns.FILE_ID, FontsContractCompat.Columns.TTC_INDEX, FontsContractCompat.Columns.VARIATION_SETTINGS, FontsContractCompat.Columns.WEIGHT, FontsContractCompat.Columns.ITALIC, FontsContractCompat.Columns.RESULT_CODE};
            int i3 = 0;
            ...
            if (cursor != null && cursor.getCount() > 0) {
                ...
                int columnIndex2 = cursor.getColumnIndex(Constants.DATABASE_TABLE_FIELD_ID);
