        ...
        */
        public RemoteViews applyStandardTemplate(boolean z, int i, boolean z2) {
            ...
            if (Build.VERSION.SDK_INT >= 16 && Build.VERSION.SDK_INT < 21) {
                if (z6) {
                    remoteViews.setInt(C0188R.C0191id.notification_background, "setBackgroundResource", C0188R.C0190drawable.notification_bg_low);
                    remoteViews.setInt(C0188R.C0191id.icon, "setBackgroundResource", C0188R.C0190drawable.notification_template_icon_low_bg);
                } else {
                    remoteViews.setInt(C0188R.C0191id.notification_background, "setBackgroundResource", C0188R.C0190drawable.notification_bg);
                    remoteViews.setInt(C0188R.C0191id.icon, "setBackgroundResource", C0188R.C0190drawable.notification_template_icon_bg);
                }
            }
            if (this.mBuilder.mLargeIcon != null) {
                if (Build.VERSION.SDK_INT >= 16) {
                    remoteViews.setViewVisibility(C0188R.C0191id.icon, 0);
                    remoteViews.setImageViewBitmap(C0188R.C0191id.icon, this.mBuilder.mLargeIcon);
                } else {
                    remoteViews.setViewVisibility(C0188R.C0191id.icon, 8);
                }
                if (z && this.mBuilder.mNotification.icon != 0) {
                    int dimensionPixelSize = resources.getDimensionPixelSize(C0188R.dimen.notification_right_icon_size);
                    int dimensionPixelSize2 = dimensionPixelSize - (resources.getDimensionPixelSize(C0188R.dimen.notification_small_icon_background_padding) * 2);
                    if (Build.VERSION.SDK_INT >= 21) {
                        remoteViews.setImageViewBitmap(C0188R.C0191id.right_icon, createIconWithBackground(this.mBuilder.mNotification.icon, dimensionPixelSize, dimensionPixelSize2, this.mBuilder.getColor()));
                    } else {
                        remoteViews.setImageViewBitmap(C0188R.C0191id.right_icon, createColoredBitmap(this.mBuilder.mNotification.icon, -1));
                    }
                    remoteViews.setViewVisibility(C0188R.C0191id.right_icon, 0);
                }
            } else if (z && this.mBuilder.mNotification.icon != 0) {
                remoteViews.setViewVisibility(C0188R.C0191id.icon, 0);
                if (Build.VERSION.SDK_INT >= 21) {
                    remoteViews.setImageViewBitmap(C0188R.C0191id.icon, createIconWithBackground(this.mBuilder.mNotification.icon, resources.getDimensionPixelSize(C0188R.dimen.notification_large_icon_width) - resources.getDimensionPixelSize(C0188R.dimen.notification_big_circle_margin), resources.getDimensionPixelSize(C0188R.dimen.notification_small_icon_size_as_large), this.mBuilder.getColor()));
                } else {
                    remoteViews.setImageViewBitmap(C0188R.C0191id.icon, createColoredBitmap(this.mBuilder.mNotification.icon, -1));
                }
            }
            if (this.mBuilder.mContentTitle != null) {
                remoteViews.setTextViewText(C0188R.C0191id.title, this.mBuilder.mContentTitle);
            }
            if (this.mBuilder.mContentText != null) {
                remoteViews.setTextViewText(C0188R.C0191id.text, this.mBuilder.mContentText);
                z3 = true;
            } else {
                z3 = false;
            }
            z5 = Build.VERSION.SDK_INT < 21 && this.mBuilder.mLargeIcon != null;
            if (this.mBuilder.mContentInfo != null) {
                remoteViews.setTextViewText(C0188R.C0191id.info, this.mBuilder.mContentInfo);
                remoteViews.setViewVisibility(C0188R.C0191id.info, 0);
            } else if (this.mBuilder.mNumber > 0) {
                if (this.mBuilder.mNumber > resources.getInteger(C0188R.integer.status_bar_notification_info_maxnum)) {
                    remoteViews.setTextViewText(C0188R.C0191id.info, resources.getString(C0188R.string.status_bar_notification_info_overflow));
                } else {
                    remoteViews.setTextViewText(C0188R.C0191id.info, NumberFormat.getIntegerInstance().format(this.mBuilder.mNumber));
                }
                remoteViews.setViewVisibility(C0188R.C0191id.info, 0);
            } else {
                remoteViews.setViewVisibility(C0188R.C0191id.info, 8);
                if (this.mBuilder.mSubText != null && Build.VERSION.SDK_INT >= 16) {
                    remoteViews.setTextViewText(C0188R.C0191id.text, this.mBuilder.mSubText);
                    if (this.mBuilder.mContentText == null) {
                        remoteViews.setTextViewText(C0188R.C0191id.text2, this.mBuilder.mContentText);
                        remoteViews.setViewVisibility(C0188R.C0191id.text2, 0);
                        z4 = true;
                        if (z4 && Build.VERSION.SDK_INT >= 16) {
                            if (z2) {
                                remoteViews.setTextViewTextSize(C0188R.C0191id.text, 0, resources.getDimensionPixelSize(C0188R.dimen.notification_subtext_size));
                            }
                            remoteViews.setViewPadding(C0188R.C0191id.line1, 0, 0, 0, 0);
                        }
                        if (this.mBuilder.getWhenIfShowing() != 0) {
                            if (!this.mBuilder.mUseChronometer || Build.VERSION.SDK_INT < 16) {
                                remoteViews.setViewVisibility(C0188R.C0191id.time, 0);
                                remoteViews.setLong(C0188R.C0191id.time, "setTime", this.mBuilder.getWhenIfShowing());
                            } else {
                                remoteViews.setViewVisibility(C0188R.C0191id.chronometer, 0);
                                remoteViews.setLong(C0188R.C0191id.chronometer, "setBase", this.mBuilder.getWhenIfShowing() + (SystemClock.elapsedRealtime() - System.currentTimeMillis()));
                                remoteViews.setBoolean(C0188R.C0191id.chronometer, "setStarted", true);
                                if (this.mBuilder.mChronometerCountDown && Build.VERSION.SDK_INT >= 24) {
                                    remoteViews.setChronometerCountDown(C0188R.C0191id.chronometer, this.mBuilder.mChronometerCountDown);
                                }
                            }
                        }
                        remoteViews.setViewVisibility(C0188R.C0191id.right_side, z5 ? 0 : 8);
                        int i3 = C0188R.C0191id.line3;
                        if (!z3) {
                            i2 = 8;
                        }
