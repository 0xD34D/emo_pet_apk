                ...
                if (itemInfo2 != null) {
                    ...
                    for (int i6 = this.mCurItem - 1; i6 >= 0; i6--) {
                        if (f < paddingLeft || i6 >= max) {
                            ...
                            break;
                        } else if (i6 == itemInfo3.position && !itemInfo3.scrolling) {
                    ...
                    int i7 = i4 + 1;
                    if (f2 < 2.0f) {
                        ItemInfo itemInfo4 = i7 < this.mItems.size() ? this.mItems.get(i7) : null;
                ...
                if (layoutParams.isDecor) {
                    ...
                    if (i9 != 1) {
                        if (i9 == 3) {
                            ...
                            paddingLeft = (i5 - paddingRight) - childAt.getMeasuredWidth();
                        ...
                        if (i10 == 16) {
                            if (i10 == 48) {
                                ...
                                paddingTop = (i6 - paddingBottom) - childAt.getMeasuredHeight();
        ...
        for (int i13 = 0; i13 < childCount; i13++) {
            ...
            if (childAt2.getVisibility() != 8) {
                ...
                if (!layoutParams2.isDecor && (infoForChild = infoForChild(childAt2)) != null) {
                    float f = i12;
                    int i14 = ((int) (infoForChild.offset * f)) + paddingLeft;
