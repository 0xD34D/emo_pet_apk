...
public class AlertController {
    ...
    public AlertController(Context context, AppCompatDialog appCompatDialog, Window window) {
        ...
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(null, C0041R.styleable.AlertDialog, C0041R.attr.alertDialogStyle, 0);
    ...
    private void setupView() {
        ...
        if (!(z2 || resolvePanel2 == null || (findViewById2 = resolvePanel2.findViewById(C0041R.C0044id.textSpacerNoButtons)) == null)) {
