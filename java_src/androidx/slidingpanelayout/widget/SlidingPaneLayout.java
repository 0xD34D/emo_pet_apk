        ...
        while (true) {
            ...
            if (childAt.getVisibility() == 8) {
                ...
                if (layoutParams.width == -2) {
                    ...
                    i9 = View.MeasureSpec.makeMeasureSpec(paddingLeft - i13, BasicMeasure.EXACTLY);
                } else {
                ...
                if (layoutParams.height == -2) {
                    ...
                    i10 = View.MeasureSpec.makeMeasureSpec(layoutParams.height, BasicMeasure.EXACTLY);
                }
                        ...
                        if (!z2 || childAt2 == this.mSlideableView) {
                            if (layoutParams2.weight > 0.0f) {
                                if (layoutParams2.width != 0) {
                                    i6 = View.MeasureSpec.makeMeasureSpec(childAt2.getMeasuredHeight(), BasicMeasure.EXACTLY);
                                } else if (layoutParams2.height == -2) {
                                    i6 = View.MeasureSpec.makeMeasureSpec(i3, Integer.MIN_VALUE);
                                } else if (layoutParams2.height == -1) {
                                    i6 = View.MeasureSpec.makeMeasureSpec(i3, BasicMeasure.EXACTLY);
                                } else {
                                    i6 = View.MeasureSpec.makeMeasureSpec(layoutParams2.height, BasicMeasure.EXACTLY);
                                }
                                if (z2) {
                                    ...
                                    i14 = i14;
                                    childAt2.measure(View.MeasureSpec.makeMeasureSpec(measuredWidth2 + ((int) ((layoutParams2.weight * Math.max(0, i12)) / f)), BasicMeasure.EXACTLY), i6);
                                    i15++;
                                    i5 = 8;
                                }
                            }
