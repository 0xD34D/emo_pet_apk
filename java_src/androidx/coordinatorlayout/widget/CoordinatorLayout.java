...
public class CoordinatorLayout extends ViewGroup implements NestedScrollingParent2, NestedScrollingParent3 {
    ...
    */
    protected void onMeasure(int i, int i2) {
            ...
            if (view.getVisibility() == 8) {
                ...
                if (layoutParams2.keyline < 0 || mode == 0) {
                    ...
                    if (z2 || ViewCompat.getFitsSystemWindows(view)) {
                        ...
                        i7 = View.MeasureSpec.makeMeasureSpec(size - (this.mLastInsets.getSystemWindowInsetLeft() + this.mLastInsets.getSystemWindowInsetRight()), mode);
                    ...
                    onMeasureChild(view, i7, i5, i6, 0);
                    i13 = Math.max(i10, i11 + view.getMeasuredWidth() + layoutParams.leftMargin + layoutParams.rightMargin);
                    i14 = Math.max(i8, i12 + view.getMeasuredHeight() + layoutParams.topMargin + layoutParams.bottomMargin);
                    i15 = View.combineMeasuredStates(i9, view.getMeasuredState());
                }
                i5 = 0;
                if (z2) {
                }
        ...
        setMeasuredDimension(View.resolveSizeAndState(i13, i, (-16777216) & i15), View.resolveSizeAndState(i14, i2, i15 << 16));
    }
