...
import androidx.databinding.library.C0302R;
...
public abstract class ViewDataBinding extends BaseObservable implements ViewBinding {
    ...
    protected void setRootTag(View view) {
        view.setTag(C0302R.C0305id.dataBinding, this);
    }
    ...
    public static ViewDataBinding getBinding(View view) {
        if (view != null) {
            return (ViewDataBinding) view.getTag(C0302R.C0305id.dataBinding);
        }
        return null;
    }
    ...
    private static void mapBindings(DataBindingComponent dataBindingComponent, View view, Object[] objArr, IncludedLayouts includedLayouts, SparseIntArray sparseIntArray, boolean z) {
        ...
        if (getBinding(view) == null) {
            ...
            if (z && str != null && str.startsWith("layout")) {
                ...
                i = parseTagInt(str, BINDING_NUMBER_START);
                if (objArr[i] == null) {
                    objArr[i] = view;
                }
                if (includedLayouts == null) {
            ...
            if (view instanceof ViewGroup) {
                ...
                while (i7 < childCount) {
                    ...
                    if (i >= 0 && (childAt.getTag() instanceof String)) {
                        ...
                        if (str2.endsWith("_0") && str2.startsWith("layout") && str2.indexOf(47) > 0 && (findIncludeIndex = findIncludeIndex(str2, i8, includedLayouts, i)) >= 0) {
                            int i9 = findIncludeIndex + 1;
                            int i10 = includedLayouts.indexes[i][findIncludeIndex];
                            int i11 = includedLayouts.layoutIds[i][findIncludeIndex];
                            ...
                            if (findLastMatching == i7) {
                                ...
                                int i12 = (findLastMatching - i7) + i5;
