...
class ViewGroupUtilsApi14 {
    ...
    */
    public static void suppressLayout(ViewGroup viewGroup, boolean z) {
        ...
        if (z) {
            ...
            if (layoutTransition3 != null) {
                ...
                if (layoutTransition3 != sEmptyLayoutTransition) {
                    viewGroup.setTag(C0555R.C0558id.transition_layout_save, layoutTransition3);
                }
            }
            ...
            try {
                ...
                if (z3) {
                    try {
                        ...
                        layoutTransition = (LayoutTransition) viewGroup.getTag(C0555R.C0558id.transition_layout_save);
        ...
        layoutTransition = (LayoutTransition) viewGroup.getTag(C0555R.C0558id.transition_layout_save);
        if (layoutTransition == null) {
            viewGroup.setTag(C0555R.C0558id.transition_layout_save, null);
