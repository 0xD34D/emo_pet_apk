...
class MessageThreadUtil<T> implements ThreadUtil<T> {
    ...
    /* loaded from: classes.dex */
    class C04891 implements ThreadUtil.MainThreadCallback<T> {
        ...
        private Runnable mMainThreadRunnable = new Runnable() { // from class: androidx.recyclerview.widget.MessageThreadUtil.1.1
            ...
            public void run() {
                SyncQueueItem next = C04891.this.mQueue.next();
                while (next != null) {
                    int i = next.what;
                    if (i == 1) {
                        C04891.this.val$callback.updateItemCount(next.arg1, next.arg2);
                    } else if (i == 2) {
                        C04891.this.val$callback.addTile(next.arg1, (TileList.Tile) next.data);
                    } else if (i != 3) {
                        Log.e("ThreadUtil", "Unsupported message, what=" + next.what);
                    } else {
                        C04891.this.val$callback.removeTile(next.arg1, next.arg2);
                    }
                    next = C04891.this.mQueue.next();
                }
            }
        };

        C04891(ThreadUtil.MainThreadCallback mainThreadCallback) {
    ...
    public ThreadUtil.MainThreadCallback<T> getMainThreadProxy(ThreadUtil.MainThreadCallback<T> mainThreadCallback) {
        return new C04891(mainThreadCallback);
    }

    /* renamed from: androidx.recyclerview.widget.MessageThreadUtil$2 */
    /* loaded from: classes.dex */
    class C04912 implements ThreadUtil.BackgroundCallback<T> {
        ...
        private Runnable mBackgroundRunnable = new Runnable() { // from class: androidx.recyclerview.widget.MessageThreadUtil.2.1
            ...
            public void run() {
                while (true) {
                    SyncQueueItem next = C04912.this.mQueue.next();
                    if (next == null) {
                    ...
                    if (i == 1) {
                        ...
                        C04912.this.val$callback.refresh(next.arg1);
                    } else if (i == 2) {
                        C04912.this.mQueue.removeMessages(2);
                        C04912.this.mQueue.removeMessages(3);
                        C04912.this.val$callback.updateRange(next.arg1, next.arg2, next.arg3, next.arg4, next.arg5);
                    } else if (i == 3) {
                        C04912.this.val$callback.loadTile(next.arg1, next.arg2);
                    } else if (i != 4) {
                        Log.e("ThreadUtil", "Unsupported message, what=" + next.what);
                    } else {
                        C04912.this.val$callback.recycleTile((TileList.Tile) next.data);
                    }
                }
            }
        };

        C04912(ThreadUtil.BackgroundCallback backgroundCallback) {
    ...
    public ThreadUtil.BackgroundCallback<T> getBackgroundProxy(ThreadUtil.BackgroundCallback<T> backgroundCallback) {
        return new C04912(backgroundCallback);
    }
