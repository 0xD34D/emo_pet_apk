    ...
    void layoutChunk(RecyclerView.Recycler recycler, RecyclerView.State state, LinearLayoutManager.LayoutState layoutState, LinearLayoutManager.LayoutChunkResult layoutChunkResult) {
        ...
        for (int i19 = 0; i19 < i11; i19++) {
            ...
            if (this.mOrientationHelper.getDecoratedMeasurement(view3) != i14) {
                ...
                if (this.mOrientation == 1) {
                    i8 = getChildMeasureSpec(spaceForSpanRange, BasicMeasure.EXACTLY, i21, layoutParams.width, false);
                    i7 = View.MeasureSpec.makeMeasureSpec(i14 - i20, BasicMeasure.EXACTLY);
                } else {
                    int makeMeasureSpec = View.MeasureSpec.makeMeasureSpec(i14 - i21, BasicMeasure.EXACTLY);
                    i7 = getChildMeasureSpec(spaceForSpanRange, BasicMeasure.EXACTLY, i20, layoutParams.height, false);
                    i8 = makeMeasureSpec;
                }
        ...
        while (i22 < i11) {
            ...
            if (this.mOrientation != 1) {
                ...
                i = paddingLeft2;
                i5 = i2;
                layoutDecoratedWithMargins(view4, i, i5, i3, i6);
                            ...
                            if (min > i10) {
                                ...
                                if (z) {
                                    if (childAt.hasFocusable()) {
                                        ...
                                        i9 = Math.min(i13, i6) - Math.max(i12, i5);
                                        i7 = i14;
                                        i10 = i10;
                                        i8 = i8;
                                        view3 = view3;
